...
Cube::Cube( float l, float h, float p) : m_longueur(l), m_hauteur(h), m_profondeur(p)
{
	...
	GLfloat vertex_data[] = {
	 -m_longueur/2, 0.0f,-m_longueur/2, // triangle 1 : begin
	-m_longueur/2, 0.0f, m_longueur/2,
	-m_longueur/2, m_hauteur, m_longueur/2, // triangle 1 : end
	m_longueur/2, m_hauteur,-m_longueur/2, // triangle 2 : begin
	-m_longueur/2,0.0f,-m_longueur/2,
	-m_longueur/2, m_hauteur,-m_longueur/2, // triangle 2 : end
	m_longueur/2, 0.0f, m_longueur/2,
	-m_longueur/2,0.0f,-m_longueur/2,
	m_longueur/2, 0.0f,-m_longueur/2,
	m_longueur/2, m_hauteur,-m_longueur/2,
	m_longueur/2, 0.0f,-m_longueur/2,
	-m_longueur/2,0.0f,-m_longueur/2,
	-m_longueur/2,0.0f,-m_longueur/2,
	-m_longueur/2, m_hauteur, m_longueur/2,
